  ...
  return (
    ...
    >
      <div className="max-w-[900px] mx-auto px-4 md:px-5 h-14 flex items-center justify-between">
        ...
        >
          <span className="block text-xs md:text-sm font-semibold text-text-primary tracking-tight">
            KHU LikeLion
          </span>
          <span className="block font-mono text-[9px] md:text-[10px] text-accent-primary/70 tracking-[0.2em] uppercase">
            Tech Blog
          </span>
        </Link>
